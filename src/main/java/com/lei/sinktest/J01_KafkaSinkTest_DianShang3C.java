 ...
 */
public class J01_KafkaSinkTest_DianShang3C {
    public static void main(String[] args) throws Exception {
        ...
        // source
        DataStream<String> inputStream = env.readTextFile("input_dir/dianshang_3c.txt");
...
//        });
        ...
        inputStream.addSink(J_MyKafkaUtil.getProducer("dianshang_3c")); // topic_news
        /*
        # 创建topic
            kafka-topics --create --zookeeper node-01:2181,node-02:2181,node-03:2181 --replication-factor 3 --partitions 3 --topic flink_topic_test
        # 查看topic
